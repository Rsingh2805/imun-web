                    ...
                    <div class="col-lg-6 push-lg-3 col-md-8 push-md-2 col-sm-10 push-sm-1 forgotpwd_margin">
                        <div class="login_logo login_border_radius1">
                            <h3 class="text-xs-center">
                                <span class="text-white"> IMUN &nbsp;<br />
                                    Forgot Password</span>
                            </h3>
                        </div>
                        <form action="http://dev.lorvent.com/admire/login.html" id="login_validator1" method="post"
                            ...
                            <div class="bg-white login_content login_border_radius">
                                ...
                                <div class="form-group form-actions">
                                    <button type="submit" class="btn btn-primary submit_email login_button" onclick="window.location.href='login.html'">
                                        Submit
